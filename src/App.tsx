...
function App() {
  ...
  useHomeSeo({ title: seo.title, description: seo.description })
  ...
  return (
    <main className="min-h-screen bg-background bg-[length:24px_24px] [background-image:radial-gradient(circle,hsl(var(--dot-grid))_1px,transparent_1px)]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
              <p className="text-lg text-muted-foreground mb-2">
                Hi, I'm <Link to="/about" className="text-gradient-theme font-semibold hover:opacity-80 transition-opacity">Louis Lu</Link>,
              </p>
      ...
      {/* Projects */}
      <section id="projects" className="py-16 md:py-24" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 1200px' }}>
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            <h2 className="font-display text-2xl font-semibold mb-8 flex items-center gap-3">
      ...
      <section id="education" className="py-16 md:py-24" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 1000px' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className={t.certifications.items.length > 0 ? 'grid md:grid-cols-2 gap-12' : 'max-w-2xl'}>
            {/* Education */}
            <div>
              <AnimatedSection>
                <h2 className="font-display text-2xl font-semibold mb-8 flex items-center gap-3">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <AnimatedSection delay={0.1}>
              ...
              <div className="space-y-3">
                {t.skills.languageList.map((lang, i) => (
                  <div key={lang.name} className="flex justify-between items-center">
                    <span>{lang.name}</span>
                    <span className={i === 0 ? 'text-sm text-primary font-medium' : 'text-sm text-muted-foreground'}>{lang.level}</span>
                  </div>
                ))}
              </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <AnimatedSection delay={0.1}>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/louis-lu-5b220713b/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <p className="mt-12 text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Louis Lu
