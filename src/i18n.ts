...
export const translations = {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: 'Musaic — Music Sharing Web App',
          badge: 'COGS121, UC San Diego',
          desc: 'Conceptual music-sharing app built on the Spotify API — friends see each other’s top songs/artists, 30-second previews, and can add tracks straight to their own library. Built with a Firebase backend as product designer and backend developer.',
          tech: ['JavaScript', 'Spotify API', 'Firebase'],
          link: { label: 'GitHub', href: 'https://github.com/yil479/musaic' },
        },
        {
          title: 'San Diego Air Pollution Analysis',
          badge: 'PCA + Linear Regression',
          desc: 'Modeled U.S. Air Quality Index data with PCA and linear regression to study how pollutant levels relate to air-quality outcomes, using MATLAB and R for the full analysis pipeline.',
          tech: ['MATLAB', 'R', 'PCA', 'Linear Regression'],
        },
        {
          title: 'San Diego Traffic Collision Analysis',
          badge: 'Presented at HDSI',
          desc: 'Analyzed police collision reports and traffic-volume data to test whether higher-traffic San Diego streets are more dangerous, measuring danger by accident and injury counts. Findings drew interest from the City of San Diego.',
          tech: ['Python', 'Statistical Analysis', 'Data Visualization'],
          link: { label: 'GitHub', href: 'https://github.com/yil479/SD-Car-Accident-Analysis/blob/master/FinalProject.ipynb' },
        },
        {
          title: 'TeamUp2018',
          badge: 'UI/UX + Backend',
          desc: 'UI/UX design and backend development for a team-matching web app.',
          tech: ['UI/UX Design', 'Backend Development'],
          link: { label: 'View site', href: 'https://yil479.wixsite.com/teamup2018' },
        },
        {
          title: 'KitchIn — Food-Sharing Platform',
          badge: 'Team Lead',
          desc: 'Led a 3-member team building an interactive platform for college students to share or sell home-cooked food, cutting food waste and food costs. First software product — worked across front end, back end, UI design, and usability analysis.',
          tech: ['Front End', 'Back End', 'UI Design'],
          link: { label: 'View site', href: 'https://amberly-n.github.io/KitchIn-1/' },
        },
      ] as { title: string; badge: string; desc: string; tech: string[]; link?: { label: string; href: string } }[],
    },
    skills: {
      title: 'Skills',
