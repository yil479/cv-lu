...
// Empty until new articles are registered in src/articles/registry.ts —
// add an entry here (id -> keyword list) for each one.
...
// Empty until new articles are registered — add an entry per article id.
